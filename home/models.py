...
class p_message(models.Model):
    ...
    m_address_province = models.CharField(max_length=80, help_text="所属地区代码(省级)", default="")
    m_address_city = models.CharField(max_length=80, help_text="所属地区代码(市级)", default="")
    m_address_belong = models.CharField(max_length=80, help_text="所属地区代码（地区）", default="")
