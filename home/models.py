...
class p_message(models.Model):
    ...
    m_address_province = models.IntegerField(help_text="所属地区代码(省级)", default="")
    m_address_city = models.IntegerField(help_text="所属地区代码(市级)", default="")
    m_address_belong = models.IntegerField(help_text="所属地区代码（地区）", default="")
...
class p_message_contact(models.Model):
    ...
    address_province = models.IntegerField(help_text="所属地区代码(省级)", default="")
    address_city = models.IntegerField(help_text="所属地区代码(市级)", default="")
    address_belong = models.IntegerField(help_text="所属地区代码（地区）", default="")
